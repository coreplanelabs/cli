...
type NodeTypeArg = Parameters<PolylaneAPI['cloudInfraNodesGet']>[0] extends { type: infer T } ? T : never;
...
export const serviceShowCommand: Command = {
  ...
  examples: [
    'polylane service show aws/123456789/us-east-1/aws.lambda.function/payments',
    'polylane service show payments',
  ],
